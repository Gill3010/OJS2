<?php
/* Smarty version 4.3.1, created on 2025-02-27 13:16:49
  from 'app:controllersgridsettingssectionsformsectionForm.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67c065c13264d0_15090169',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'c3e41bcfd4f6ae321a07ea76eba0d6840e716fb7' => 
    array (
      0 => 'app:controllersgridsettingssectionsformsectionForm.tpl',
      1 => 1732910684,
      2 => 'app',
    ),
  ),
...
function content_67c065c13264d0_15090169 (Smarty_Internal_Template $_smarty_tpl) {
echo '<script'; ?>
...
ob_start();?>
			...
			<?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"editorRestricted",'checked'=>$_smarty_tpl->tpl_vars['editorRestricted']->value,'label'=>"manager.sections.editorRestriction"),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->_cache['_tag_stack'][] = array('fbvFormSection', array('list'=>true,'title'=>"manager.sections.form.assignEditors"));
$_block_repeat=true;
echo $_block_plugin10->smartyFBVFormSection(array('list'=>true,'title'=>"manager.sections.form.assignEditors"), null, $_smarty_tpl, $_block_repeat);
while ($_block_repeat) {
ob_start();?>
	<div><?php echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"manager.sections.form.assignEditors.description"),$_smarty_tpl ) );?>
</div>
	<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['assignableUserGroups']->value, 'assignableUserGroup');
$_smarty_tpl->tpl_vars['assignableUserGroup']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['assignableUserGroup']->value) {
$_smarty_tpl->tpl_vars['assignableUserGroup']->do_else = false;
?>
		<?php $_smarty_tpl->_assignInScope('role', $_smarty_tpl->tpl_vars['assignableUserGroup']->value['userGroup']->getLocalizedName());?>
		<?php $_smarty_tpl->_assignInScope('userGroupId', $_smarty_tpl->tpl_vars['assignableUserGroup']->value['userGroup']->getId());?>
		<?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['assignableUserGroup']->value['users'], 'username', false, 'id');
$_smarty_tpl->tpl_vars['username']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['id']->value => $_smarty_tpl->tpl_vars['username']->value) {
$_smarty_tpl->tpl_vars['username']->do_else = false;
?>
			<?php ob_start();
echo call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['userGroupId']->value ));
$_prefixVariable1=ob_get_clean();
ob_start();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['translate'][0], array( array('key'=>"manager.sections.form.assignEditorAs",'name'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['username']->value )),'role'=>call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'escape' ][ 0 ], array( $_smarty_tpl->tpl_vars['role']->value ))),$_smarty_tpl ) );
$_prefixVariable2 = ob_get_clean();
echo call_user_func_array( $_smarty_tpl->smarty->registered_plugins[Smarty::PLUGIN_FUNCTION]['fbvElement'][0], array( array('type'=>"checkbox",'id'=>"subEditors[".$_prefixVariable1."][]",'value'=>$_smarty_tpl->tpl_vars['id']->value,'checked'=>((isset($_smarty_tpl->tpl_vars['subeditorUserGroups']->value[$_smarty_tpl->tpl_vars['id']->value])) && in_array($_smarty_tpl->tpl_vars['userGroupId']->value,$_smarty_tpl->tpl_vars['subeditorUserGroups']->value[$_smarty_tpl->tpl_vars['id']->value])),'label'=>$_prefixVariable2,'translate'=>false),$_smarty_tpl ) );?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
	<?php $_block_repeat=false;
echo $_block_plugin10->smartyFBVFormSection(array('list'=>true,'title'=>"manager.sections.form.assignEditors"), ob_get_clean(), $_smarty_tpl, $_block_repeat);
}
array_pop($_smarty_tpl->smarty->_cache['_tag_stack']);?>
