...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.3.1',
  'unifunc' => 'content_67c0656ad61a25_28308160',
  ...
  'includes' => 
  array (
    'app:workflow/submissionIdentification.tpl' => 1,
    'app:controllers/notification/inPlaceNotification.tpl' => 1,
  ),
),false)) {
function content_67c0656ad61a25_28308160 (Smarty_Internal_Template $_smarty_tpl) {
...
<?php 
$_smarty_tpl->inheritance->instanceBlock($_smarty_tpl, 'Block_129062256167c0656ad4b207_47975261', "page");
?>

<?php $_smarty_tpl->inheritance->endChild($_smarty_tpl, "layouts/backend.tpl");
}
/* {block "page"} */
class Block_129062256167c0656ad4b207_47975261 extends Smarty_Internal_Block
{
public $subBlocks = array (
  'page' => 
  array (
    0 => 'Block_129062256167c0656ad4b207_47975261',
  ),
);
...
?>
	...
	<pkp-header :is-one-line="true" class="pkpWorkflow__header">
		<h1 class="pkpWorkflow__identification">
			...
			<?php $_smarty_tpl->_subTemplateRender("app:workflow/submissionIdentification.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
		</h1>
...
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);?>
				...
				title="Revisions"
			>
				<pkp-form v-bind="components.<?php echo (defined('FORM_SELECT_REVISION_DECISION') ? constant('FORM_SELECT_REVISION_DECISION') : null);?>
" @set="set" @success="goToRevisionDecision" />
			</modal>
				...
				title="Revisions"
			>
				<pkp-form v-bind="components.<?php echo (defined('FORM_SELECT_REVISION_RECOMMENDATION') ? constant('FORM_SELECT_REVISION_RECOMMENDATION') : null);?>
" @set="set" @success="goToRevisionDecision" />
			</modal>
		</tab>
